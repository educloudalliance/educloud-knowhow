...
*/
	return array(
		...
		'captcha_login_fix' => 'Vältä tämä varmistus jatkossa ^1kirjautumalla sisään^2 tai ^3rekisteröidy^4.',
		'feed_a_edited_prefix' => 'Vastausta muutettu: ',
		'feed_a_prefix' => 'Vastattu: ',
		'feed_a_reshown_prefix' => 'Vastaus näytetään taas: ',
		'feed_a_selected_prefix' => 'Valittu vastaus: ',
		'feed_c_edited_prefix' => 'Kommenttia muutettu: ',
		'feed_c_moved_prefix' => 'Kommentti siirretty: ',
		'feed_c_prefix' => 'Kommentoitu: ',
		'feed_c_reshown_prefix' => 'Kommentti näytetään taas: ',
		'feed_closed_prefix' => 'Suljettu: ',
		...
		'feedback_email' => 'Sähköpostisi: (vapaavalintainen)',
		'feedback_empty' => 'Ystävällisesti käytä tätä kenttää kommentteihin tai ehdotuksiin',
		'feedback_message' => 'Kommenttisi tai ehdotuksesi ^:',
		...
		'no_favorite_tags' => 'Ei suosikkiavainsanoja',
		'no_favorite_users' => 'Ei suosikkikäyttäjiä',
		...
		'recent_updates_favorites' => 'Tuoreimmat suosikkini',
		'recent_updates_title' => 'Viimeisimmät päivitykset minulle',
		'site_in_maintenance' => 'Sivustoa ylläpidetään - palaa hetken kuluttua.',
